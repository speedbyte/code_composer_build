...
|
| Subversion Info:
| $Id: ADLATUS_ExternalWatchdogFlash.c 4415 2008-11-11 08:35:58Z maennel $
| $HeadURL: http://smartsvn/svn/adlatusrepository/auslieferungen/S1NN/086350-S1NN-ADLATUS-TMS470R-MucSuc/20081201_S1NN_TMS470R_BlfIso-Source_V1.00/01_SW_Projekt/03_fsw/02_src/ADLATUS_ExternalWatchdogFlash.c $
|
+------------------------------------------------------------------------------+
...
#define  d_CCwtdog_InitExtWdogTime      (1) /* 1 = 1ms */
