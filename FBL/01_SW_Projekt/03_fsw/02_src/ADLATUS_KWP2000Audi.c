...
|
| Subversion Info:
| $Id: ADLATUS_KWP2000Audi.c 4432 2008-11-14 10:33:30Z maennel $
| $HeadURL: http://smartsvn/svn/adlatusrepository/auslieferungen/S1NN/086350-S1NN-ADLATUS-TMS470R-MucSuc/20081201_S1NN_TMS470R_BlfIso-Source_V1.00/01_SW_Projekt/03_fsw/02_src/ADLATUS_KWP2000Audi.c $
|
+------------------------------------------------------------------------------+
                                           ...
                                           PTR_BUFFER_UB t_OutBuffer_PBUF )
{
  ...
  if((d_CCglo_05Byte == t_InBuffer_PBUF[d_CCglo_DLC]) || \
     (d_CCglo_02Byte == t_InBuffer_PBUF[d_CCglo_DLC]))
  {   
    /*========================================================================*/
  /* -1- positiv response shall be suppressed                                 */
    /*========================================================================*/
                                          ...
                                          PTR_BUFFER_UB t_OutBuffer_PBUF )
{
  UBYTE t_Result_UB;
   ...
   return ( d_CCglo_Idle | d_CCglo_ResponseIndex00);
  /* The next line is only to prevent a compiler warning!!                    */
  ...
  else
  {
    ...
    /*========================================================================*/
    /* -2- Timelock is still running 0x37                                     */
    /*========================================================================*/
    ...
    /*========================================================================*/
    /* -2- Timelock is expired                                                */
    /*========================================================================*/
    else
    {   
      /* If too many accesses have been tried (no more Seed after 4x wrong Key) */
      if ((sECUDataAppl_ST.SecAccess_UB & (UBYTE) 0x7Fu) >= (UBYTE) 0x04u)  /* changed from " >= 0x03 " [JS] */
      {
      ...
      else
      {
        ...
        /*--------------------------------------------------------------------*/
        /* Get always a seed, also if security access had already been done   */
        /*--------------------------------------------------------------------*/
        FUN_CCsecaudi_CreateSeed_V ( (PTR_BUFFER_UB) &t_OutBuffer_PBUF[d_CCglo_StartOfData + (UBYTE)0x02u] );
                                          ...
                                          PTR_BUFFER_UB t_OutBuffer_PBUF )
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
         /* remeber the illegal key */
         t_CCkwpaudi_KwpCtrl_ST.State_UW |= d_CCkwpaudi_FlagSecurityAccessDenied;

         /* read NVM */
         FUN_CCkwpaudi_ReadTimelock_UB ( &sECUDataAppl_ST.SecAccess_UB );
         /* look for entry attepts */
         if ((sECUDataAppl_ST.SecAccess_UB & (UBYTE) 0x7Fu) <= (UBYTE) 0x03u)
         {
            /* count attempts */
                                        ...
                                        PTR_BUFFER_UB t_OutBuffer_PBUF )
{
  ...
  /*==========================================================================*/
  /* -1- The number of address bytes or memory size bytes is not correct;     */
  ...
  /*==========================================================================*/
  /* -1- The number of address bytes and memory size bytes is correct         */
  /*==========================================================================*/
  else
  {
    /*========================================================================*/
    /* -2- The length of the service request is wrong                         */
    /*========================================================================*/
    ...
    /*========================================================================*/
    /* -2- The length of the service request is correct                       */
    /*========================================================================*/
    else
    {
      /*======================================================================*/
      /* -3- Memory index consists of 1 byte                                  */
      /*======================================================================*/
      ...
      /*======================================================================*/
      /* -3- Memory index consists of 2 bytes                                 */
      /*======================================================================*/
      else
      {
        /*--------------------------------------------------------------------*/
      ...
      /*======================================================================*/
      /* -3- the memory index was not correct                                 */
      /*======================================================================*/
      ...
      /*======================================================================*/
      /* -3- the memory index was correct                                     */
      /*======================================================================*/
      else
      {
        /*====================================================================*/
        /* -4- Get the programming length dependant on the nmber of byte      */
        /*====================================================================*/
        ...
        /*====================================================================*/
        /* -4- Logical AddressCheck was correct                               */
        /*====================================================================*/
        else
        {
          /*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
          /*                                                                  */
          /* NOTE: The Flashfunctions are not onboard. So at first the flash- */
          /*       functions must be downloaded into the RAM and then a normal*/
          /*       download to the flash memory could be started!!            */
          /*                                                                  */
          /*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
          ...
          else
          {
            ...
            {
              /*==============================================================*/
              /* -7- while memory length is bigger page length                */
              /*==============================================================*/
              while (t_MemoryLength_U4.ULong_ST.ULong0_UL > (ULONG)d_CCconprj_PageLength)
              {
                /*------------------------------------------------------------*/
                /* substract page length                                      */
                /*------------------------------------------------------------*/
                t_MemoryLength_U4.ULong_ST.ULong0_UL -= (ULONG)d_CCconprj_PageLength;

              } /* -7- END OF while(..) --------------------------------------*/
              
              /*==============================================================*/
              /* -7- the memory size is not multiple of the page length       */
              /*==============================================================*/
              if ((ULONG)d_CCconprj_PageLength != t_MemoryLength_U4.ULong_ST.ULong0_UL)
              {
                /*------------------------------------------------------------*/
                /* set return value 2                                         */
                /*------------------------------------------------------------*/
              ...
              /*==============================================================*/
              /* -7- the memory size is a multiple of the page length         */
              /*==============================================================*/
              else
              {
                /*--------------------------------------------------------------*/
                ...
                /*--------------------------------------------------------------*/
                t_ReturnValue_UB = (d_CCglo_Error | 0x01);/*FUN_CChal_HISDriverCheck_UB();*/
...
const UBYTE c_CCkwpaudi_RCTRequestDownload_AUB[] = 
{
  ...
  /*--------------------------------------------------------------------------*/
  /* INDEX 02 - conditions not correct                                        */
  /*--------------------------------------------------------------------------*/
                                      ...
                                      PTR_BUFFER_UB t_OutBuffer_PBUF )
{
  ...
  /*==========================================================================*/
  /* -1- check the block sequence counter: this is the previous block which   */
  ...
  else
  {
    ...
    /*========================================================================*/
    /* -2- check the block sequence counter: it is the expected block         */
    /*========================================================================*/
    else
    {
      /*======================================================================*/
      /* -3- Too few data bytes; there have to be three bytes at least:       */
      /*          SID + blockSequenceCounter + 1 data byte                    */
      /*======================================================================*/
      if ( (UBYTE)0x03u > t_InBuffer_PBUF[d_CCglo_DLC] )
      {
        /*--------------------------------------------------------------------*/
        ...
        else       
        {
            ...
            ==  d_CCkwpaudi_FlagInternFlashDownload )
          {
            ...
            else
            {
              ...
              /*--------------------------------------------------------------*/
              FUN_CCdp_DataPrepareAudi_UB (&t_InBuffer_PBUF[0], \
                &g_CCdp_WorkingBuffer_BUF[0],
                t_CCkwpaudi_KwpCtrl_ST.DataFormatId_UB);
     
            #ifdef d_CCkwp_PageWrite
              
              t_CollectDataLength_UW = 
              FUN_CCglo_CollectData_UB ( &g_CCdp_WorkingBuffer_BUF[0], \
                                         (PTR_BUFFER_UB) &t_DataPtr_PUB  );
              ...
              if (t_CollectDataLength_UW == d_CCconprj_PageLength)
              {
                ...
                FlashParam.data    = t_DataPtr_PUB;
            #else
                FlashParam.length  = ((g_CCdp_WorkingBuffer_BUF[d_CCglo_DLC]) - 0x02);
                FlashParam.data    = &g_CCdp_WorkingBuffer_BUF[d_CCglo_StartOfData + 0x02];
            #endif
          ...
          else
          {
                   ...
                   ==  d_CCkwpaudi_FlagRamDownload )
            {
              ...
              {
                /*============================================================*/
                /* -8- Download to program ram                                */
                /*============================================================*/
                FUN_CCglo_PMemCopy_V( (FAR_PTR_UBYTE) t_CCkwpaudi_KwpCtrl_ST.ActProgAddress_UL,
                    &t_InBuffer_PBUF[d_CCglo_StartOfData + 0x02],
                    (ULONG) t_NumberOfData_UB);
            ...
            else
            {
              ...
              {
                /*============================================================*/
                /* -8- Function was called a first time                       */
                /*============================================================*/
                if ( (t_CCkwpaudi_KwpCtrl_ST.State_UW & d_CCkwpaudi_FlagRoutineBusy) != \
                  d_CCkwpaudi_FlagRoutineBusy )
                {
                ...
                /*============================================================*/
                /* -8- Function was called one more time                      */
                /*============================================================*/
                else
                {
                  /*----------------------------------------------------------*/
                  ...
                  t_NVMDirectAccess_ST.NbrBytes_UB = t_NumberOfData_UB;

                  /*----------------------------------------------------------*/
                  /* Set the number of total bytes to be written              */
                  /* in the actual transferdata session                       */
                  /*----------------------------------------------------------*/
                  t_NVMDirectAccess_ST.TotalBytes_UW = (UWORD)t_CCkwpaudi_KwpCtrl_ST.ProgLength_UL;
                  ...
                  /*==========================================================*/
                  /* -9- NVM access was not successful                        */
                  /*==========================================================*/
                  else
                  {
                    /*--------------------------------------------------------*/
...
const UBYTE c_CCkwpaudi_RCTRequestTransferExit_AUB[] = 
{
  ...
  /* 07 - RESPONSE BYTE 02 */  d_CCkwpbase_NRCConditionsNotCorrect
}; /*--- END OF TABLE --------------------------------------------------------*/
  ...
  else
  {
    ...
    else
    {
      ...
      case d_CCkwpbase_LIDStartRoutine:
        ...
        /*------------------------------------------------------------------------*/
        /* NOTE: Erasing the flash memory needs some time. Each flash memory has  */
        /*       a diffrent characteristic in order to the erase time. In fact of */
        /*       erase time is longer as the communication timeout the tester     */
        /*       will detect a communication timeout. To prevent this case we     */
        /*       will send ResponsePending. The first Response Pending is send    */
        /*       from this routine. The further ones are send from the watchdog   */
        /*       routine.                                                         */
        /*------------------------------------------------------------------------*/

        /*========================================================================*/
        /* -2- evaluate how many calls had been made of this function             */
        /*========================================================================*/
        ...
        case 0x00u:
          ...
          else
          {
            ...
            /*====================================================================*/
            /* -4- Service length is correct                                      */
            /*====================================================================*/
            else
            {
              /*==================================================================*/
              /* -5- Memory index consists of 1 byte                              */
              /*==================================================================*/
              ...
              /*==================================================================*/
              /* -5- Memory index consists of 2 bytes                             */
              /*==================================================================*/
              else
              {
                /*----------------------------------------------------------------*/
              ...
              /*==================================================================*/
              /* -5- Memory index NOT found in the download map                   */
              /*==================================================================*/
              ...
              /*==================================================================*/
              /* -5- Memory index found in the download map                       */
              /*==================================================================*/
              else
              {
                ...
                {
                  /*============================================================*/
                  /* -8- positiv response shall be suppressed                   */
                  /*============================================================*/
                  if( d_CCglo_LIDSuppressPosRsp == (d_CCglo_LIDSuppressPosRspMask &  \
                                                  t_InBuffer_PBUF[d_CCglo_StartOfData + 0x01]) )
                  {
                  ...
                  /*============================================================*/
                  /* -8- positiv response shall be send                         */
                  /*============================================================*/
                  else
                  {
                    /*----------------------------------------------------------*/
                ...
                /*==============================================================*/
                /*                                                              */
                /* -7- other memory type flash or eeprom                        */
                /*                                                              */
                /*==============================================================*/
                else
                {
        ...
        case 0x01u:
          ...
          /*============================================================*/
          /* -8- End address is lower than start address                */
          /*============================================================*/
          ...
          else
          {
               ...
               t_CCkwpaudi_KwpCtrl_ST.DownloadMap_PST[t_Index_UB].MemoryInfo_UW))
            {
              ...
              /*============================================================*/
              /* -8- Addresscheck was not correct                           */
              /*============================================================*/
              if ( d_CCglo_AddressCheckNOK == \
                (d_CCglo_AddressCheckMask & t_CCkwpaudi_KwpCtrl_ST.MemoryInfo_UW))
              {
              ...
              /*============================================================*/
              /* -8- AddressCheck was correct - area is not protected       */
              /*============================================================*/
              else
              {
                /*----------------------------------------------------------*/
                /* Check the HIS-Driver Interface-Header                    */
                /*----------------------------------------------------------*/
                t_Result_UB = (d_CCglo_Error | 0x01); /*FUN_CChal_HISDriverCheck_UB();*/
                ...
                default:
                  ...
                  /*========================================================*/
                  /* -10- the nvm access was not successful                 */
                  /*========================================================*/
                  if ( d_CCglo_NoError != t_Result_UB )
                  {
                  ...
                  /*========================================================*/
                  /* -10- if the maximum is 0x0000 we want to have the same */
                  ...
                  /*========================================================*/
                  /* -10- the maximum number of programming attempts has    */
                  /*      been reached                                      */
                  /*========================================================*/
                  ...
                  /*========================================================*/
                  /* -10- a further programming attempt is allowed          */
                  /*========================================================*/
                  else
                  {
                    if  (t_CountProgramAttempts_U2.UWord_ST.UWord0_UW != 0xFFFFu)
                    {
                      ...
                      /*======================================================*/
                      /* -11- nvm access was not successful                   */
                      /*======================================================*/
                      if ( d_CCglo_NoError != t_Result_UB )
                      {
                        /*----------------------------------------------------*/
                    ...
                    /* more than 0xffff programming cycles */
                    else
                    {
                      /*------------------------------------------------------*/
                      /* set return value - response index 5                  */
        ...
        default:
          ...
          /*======================================================================*/
          /*                                                                      */
          /* -3- Result evaluation of "erase memory"                              */
          /*                                                                      */
          /*======================================================================*/
          ...
          case kFlashOK:
            ...
            /*--------------------------------------------------------------------*/
            /* BUSY - Routine was interrupted. Not all required sectors erased.   */
            /*--------------------------------------------------------------------*/
          ...
          case kFlashEraseFailed:
            ...
            /*--------------------------------------------------------------------*/
            /* ERROR - received address parameter(s) is/are out of physical range */
            /*--------------------------------------------------------------------*/
          case kAddressOutOfRange:

            /*--------------------------------------------------------------------*/
            /* ERROR - all other errors which are possible and checked by HIS-API */
            /*--------------------------------------------------------------------*/
          default:
  ...
  case d_CCkwpbase_LIDStartRoutine:
                                                      ...
                                                      d_CCkwpaudi_FlagRoutineBusy )
    {
      ...
      else
      {
        ...
        /*====================================================================*/
        /* -4- the number of checksum bytes is not correct                    */
        /*====================================================================*/
        if ( 0x0004u != t_ChecksumNbrBytes_U2.UWord_ST.UWord0_UW )
        {
          /*------------------------------------------------------------------*/
          /* set return value - response index 3                              */
          /*------------------------------------------------------------------*/
        ...
        /*====================================================================*/
        /* -4- the number of checksum byte is correct                         */
        /*====================================================================*/
        else
        {
          /*==================================================================*/
          /* -5- Service length is not correct                                */
          /*==================================================================*/
          if ( (d_CCglo_07Byte + t_NbrIndexBytes_UB +  \
                (UBYTE) t_ChecksumNbrBytes_U2.UWord_ST.UWord0_UW) !=   \
          ...
          else
          {
            ...
            /*================================================================*/
            /* -6- Memory index NOT found in the validation map               */
            /*================================================================*/
            ...
            /*================================================================*/
            /* -6- Memory index found in the validation map                   */
            /*================================================================*/
            else
            {
              /*--------------------------------------------------------------*/
              ...
              /* Get the Checksum                                             */
              /*--------------------------------------------------------------*/
              t_Checksum_U4.UByte_ST.UByte0_UB = t_InBuffer_PBUF[d_CCglo_StartOfData + 0x07 + t_NbrIndexBytes_UB];
              t_Checksum_U4.UByte_ST.UByte1_UB = t_InBuffer_PBUF[d_CCglo_StartOfData + 0x08 + t_NbrIndexBytes_UB];
              t_Checksum_U4.UByte_ST.UByte2_UB = t_InBuffer_PBUF[d_CCglo_StartOfData + 0x09 + t_NbrIndexBytes_UB];
              t_Checksum_U4.UByte_ST.UByte3_UB = t_InBuffer_PBUF[d_CCglo_StartOfData + 0x0A + t_NbrIndexBytes_UB];
              ...
              {                                  
                ...
                /*==============================================================*/
                /* -7- table entry is a flash entry                             */
                /*==============================================================*/
                if ( d_CCglo_FlashMemory == \
                                      ...
                                      ValidationMap_PST[t_ValidationIndex_UB].CheckCondition_UW ))
                {
                  ...
                  /*       "ResponsePending". After sending we will have        */
                  /*       P3max instead of P2max for timeout.                  */
                  /*------------------------------------------------------------*/
                  /*------------------------------------------------------------*/
                  /* Set the internal busy flag                                 */
                  /*------------------------------------------------------------*/
                ...
                /*==============================================================*/
                /* -7- table entry is not a flash entry                         */
                /*==============================================================*/
                else
                {
                  /*============================================================*/
                  /* -8- table entry is a ram memory entry                      */
                  /*============================================================*/
                  if ( d_CCglo_RamMemory == \
                     (d_CCglo_MemoryTypeMask & t_CCkwpaudi_KwpCtrl_ST.  \
                                        ValidationMap_PST[t_ValidationIndex_UB].CheckCondition_UW ))
                  {
                    ...
                    /*----------------------------------------------------------*/
                    t_Result_UB = \
                      FUN_CCvalaudi_CalcCsumRamDownload_UB  \
                         ( t_CCkwpaudi_KwpCtrl_ST.ProgStartAddress_UL, \
                           t_CCkwpaudi_KwpCtrl_ST.ProgEndAddress_UL,   \
                           (ULONG) &t_CCkwpaudi_KwpCtrl_ST.Tester_Checksum_UL);

                    /*==========================================================*/
                    /* -9- Checksum is correct                                  */
                    /*==========================================================*/
                    if (t_Result_UB == d_CCglo_NoError)
                    {
                      ...
                      /*========================================================*/
                      /* -10- positiv response shall be suppressed              */
                      /*========================================================*/
                      if( d_CCglo_LIDSuppressPosRsp == (d_CCglo_LIDSuppressPosRspMask &  \
                                                    t_InBuffer_PBUF[d_CCglo_StartOfData + 0x01]) )
                      {
                      ...
                      /*========================================================*/
                      /* -10- positiv response shall be sent                    */
                      /*========================================================*/
                      else
                      {
                        /*------------------------------------------------------*/
                    ...
                    else
                    {
                      ...
                      /*======================================================*/
                      /* -B- positiv response shall be sent                   */
                      /*======================================================*/
                      else
                      {
                        /*----------------------------------------------------*/
                  ...
                  /*==========================================================*/
                  /* -9- table entry is not a ram memory entry                */
                  /*==========================================================*/
                  else
                  {
                    /*========================================================*/
                    /* -A- table entry is an eeprom memory entry              */
                    /*========================================================*/
                    ...
                    /*========================================================*/
                    /* -A- table entry is not an eeprom memory entry          */
                    /*========================================================*/
                    else
                    {
                      /*------------------------------------------------------*/
    ...
    else
    {
                              ...
                              ValidationMap_PST[t_ValidationIndex_UB].CheckCondition_UW ))
      {
        ...
        case d_CCglo_Ready:
          ...
          /*==================================================================*/
          /* -5- the checked memory has an corresponding entry in the         */
          /*     download map                                                 */
          /*==================================================================*/
                                           ...
                                           [t_ValidationIndex_UB].DownloadName_UW)
          {
            ...
            {
              /*==============================================================*/
              /* -7- entry found in the download map                          */
              /*==============================================================*/
                   ...
                   DownloadName_UW == t_CCkwpaudi_KwpCtrl_ST.DownloadMap_PST[t_Index_UB].Name_UB )
              {
                ...
                FUN_CCnvm_NvmAccess_UB ((UBYTE)( d_CCglo_Write |  \
                        ...
                        &t_CounterHelp_AUB[0]);
                /*------------------------------------------------------------*/
                /* set the software block valid and write it into the EEPROM  */
                /*------------------------------------------------------------*/
                t_ProgrammigState_UB = d_CCkwpaudi_ProgStateSWValid; 
                ...
                /*============================================================*/
                /* -8- the nvm access was not successful                      */
                /*============================================================*/
                                           ...
                                           [t_ValidationIndex_UB].DownloadName_UW)
          {
              ...
              (d_CCglo_EntryMask & t_CCkwpaudi_KwpCtrl_ST.DownloadMap_PST[t_Index_UB].MemoryInfo_UW )))
            {
                   ...
                   DownloadName_UW == t_CCkwpaudi_KwpCtrl_ST.DownloadMap_PST[t_Index_UB].Name_UB )
              {
                ...
                /*------------------------------------------------------------*/
                /* set the software block invalid and write it into the EEPROM*/
                /*------------------------------------------------------------*/
                t_ProgrammigState_UB = d_CCkwpaudi_ProgStateSWInValid; 
                                            ...
                                            PTR_BUFFER_UB t_OutBuffer_PBUF )
{
  ...
  {
    if( ((UBYTE)0x03u > t_InBuffer_PBUF[d_CCglo_DLC]) && (t_CCkwpaudi_KwpCtrl_ST.ActiveSession_UB !=  (UBYTE)0x01u)) /* [OPL333_334] */
    {
      t_OutBuffer_PBUF[d_CCglo_StartOfData + 0x02]  = d_CCkwpbase_NRCincorrectMessageLengthOrInvalidFormat;     
    } 
    else
...
UBYTE FUN_CCkwpaudi_GetSecurityLevel_UB()
{
  ...
  if ((d_CCkwpaudi_FlagSecurityAccessDenied == \
      t_CCkwpaudi_KwpCtrl_ST.State_UW & d_CCkwpaudi_FlagSecurityAccessDenied) ||
     ( 0x00 == (t_CCkwpaudi_KwpCtrl_ST.State_UW & d_CCkwpaudi_FlagSecurityAccessGranted)))
  {
    t_result_UB = 0x80;
  }
                ...
                {   
                       ...
                       ((UBYTE)c_CCconprj_EEPROM_AST[t_EEPROMIndex_UB].DataLength_UW + t_ActDLC_UB) )
                  {
                    ...
                    if (d_CCglo_NoError != FUN_CCnvm_NvmAccess_UB (\
                        c_CCconprj_LogBlockEEPROM_AUB[t_ArrayIndex_UB][t_TableIndex2_UB], \
                        (PTR_BUFFER_UB)&t_OutBuffer_PBUF[d_CCglo_StartOfData + t_ActDLC_UB] ) )
                    {
...
{ 
  ...
  /* 16 - RESPONSE BYTE 02 */  d_CCkwpbase_NRCConditionsNotCorrect,
  /*--------------------------------------------------------------------------*/
...
void FUN_CCkwpaudi_CopyEntry_V(READDATABYID_ST* ReadDataById_ST, PTR_BUFFER_UB t_OutBuffer_PBUF)
{
  ...
  t_DownloadMapIndex_UB = FUN_CCkwpaudi_AddressToMemoryMapIndex_UB  \
         (c_CCconprj_ReadDataByID_AST[ReadDataById_ST->t_TableIndexs_UB].Address_UL,
          c_CCconprj_ReadDataByID_AST[ReadDataById_ST->t_TableIndexs_UB].Address_UL +   \
          (ULONG)c_CCconprj_ReadDataByID_AST[ReadDataById_ST->t_TableIndexs_UB].NvmEntryOrLenth_UB - (ULONG)1ul);
   ...
   if ( d_CCglo_NoEntry != t_DownloadMapIndex_UB )
   {
      ...
      if ( (d_CCglo_NoError == t_ResultEval_UB) )
      {
         ...
         /* do the memcopy                                   */
         /*--------------------------------------------------*/
         FUN_CCglo_PMemCopy_V( (FAR_PTR_UBYTE)&(t_OutBuffer_PBUF[d_CCglo_StartOfData + ReadDataById_ST->t_ActDLCs_UB + 2u]),\
      ...
      else
      {
        ...
        /* do the memcopy                                   */
        /*--------------------------------------------------*/
        FUN_CCglo_PMemCopy_V( (FAR_PTR_UBYTE)&t_OutBuffer_PBUF[d_CCglo_StartOfData + ReadDataById_ST->t_ActDLCs_UB + 2],\
