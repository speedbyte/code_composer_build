...
+------------------------------------------------------------------------------+
|                                                                              |
|  Filename:  ADLATUS_FUN_Val_LinAdd16Acc16Bit_UB.c                            |
|                                                                              |
...
|
| Subversion Info:
| $Id: ADLATUS_FUN_Val_LinAdd16Acc16Bit_UB.c 4396 2008-11-04 09:26:32Z maennel $
| $HeadURL: http://smartsvn/svn/adlatusrepository/auslieferungen/S1NN/086350-S1NN-ADLATUS-TMS470R-MucSuc/20081201_S1NN_TMS470R_BlfIso-Source_V1.00/01_SW_Projekt/07_chcklib/02_src/ADLATUS_FUN_Val_LinAdd16Acc16Bit_UB.c $
|
+------------------------------------------------------------------------------+
...
+------------------------------------------------------------------------------+
|                                                                              |
|  Function Name:  ADLATUS_FUN_Val_LinAdd16Acc16Bit_UB                         |
|                                                                              |
...
UBYTE FUN_CCval_LinAdd16Acc16Bit_UB (VALCONTROL_ST  *Parameters )
{
  ...
  VHND_PTR_BUF_UWORD t_TempAddress_PUW;     /* temp address */
  ...
  t_BufferAddress_PUW = (VHND_PTR_BUF_UWORD)&Parameters->WorkingBuffer_UL;
  ...
  {
    /* Checksum correct? */
    if ( *t_BufferAddress_PUW != *(VHND_PTR_BUF_UWORD) (Parameters->ChecksumAddress_PBUF)) 
    {
  ...
  else 
  {
    ...
    /*==========================================================================*/
    while (t_TempAddress_PUW <= (VHND_PTR_BUF_UWORD)Parameters->EndAddress_PBUF) /*l_int !e946 */
    {
      /* Do calculation here and store value in working buffer */
      /* Increment Address                                                      */
      *t_BufferAddress_PUW += *t_TempAddress_PUW;
      t_TempAddress_PUW ++;
    } /* ---1- END OF while (..) -----------------------------------------------*/
    t_Result_UB = (d_CCVhnd_Ready);
  }
