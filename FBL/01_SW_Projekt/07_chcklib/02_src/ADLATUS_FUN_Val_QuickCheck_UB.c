...
+------------------------------------------------------------------------------+
|                                                                              |
|  Filename:  ADLATUS_FUN_Val_QuickCheck_UB.c                                  |
|                                                                              |
...
|
| Subversion Info:
| $Id: ADLATUS_FUN_Val_QuickCheck_UB.c 4396 2008-11-04 09:26:32Z maennel $
| $HeadURL: http://smartsvn/svn/adlatusrepository/auslieferungen/S1NN/086350-S1NN-ADLATUS-TMS470R-MucSuc/20081201_S1NN_TMS470R_BlfIso-Source_V1.00/01_SW_Projekt/07_chcklib/02_src/ADLATUS_FUN_Val_QuickCheck_UB.c $
|                                                                              |
+------------------------------------------------------------------------------+
...
+------------------------------------------------------------------------------+
|                                                                              |
|  Function Name:  FUN_CCval_QuickCheck_UB                                     |
|                                                                              |
...
UBYTE FUN_CCval_QuickCheck_UB (VALCONTROL_ST  *Parameters )
{
  ...
  if ( d_CCVhnd_CheckForResult == (d_CCVhnd_CheckForResult & Parameters->Control_UB) )
  {
    ...
    case d_CCglo_01Byte:
      /* Convert the address                                            */
      t_TempVar_UB = *Parameters->ChecksumAddress_PBUF;

      /*================================================================*/
      /*  -5- No FSW programmed                                         */
      /*================================================================*/
      if ( (0xFF == t_TempVar_UB) || \
           (0x00 == t_TempVar_UB)    )
      {
    ...
    case d_CCglo_02Byte:
      ...
      /*  -5- No FSW programmed                                         */
      /*================================================================*/
      if ( (0xFFFFu == t_TempVar_UW) || \
        (0x0000u == t_TempVar_UW)    )
      {
        t_Result_UB = (d_CCVhnd_CheckNOK | d_CCVhnd_Ready);
      } /* -5- END OF if(..) -------------------------------------------*/
      break;
    ...
    case d_CCglo_04Byte:
      ...
      /*  -5- No FSW programmed                                         */
      /*================================================================*/
      if ( (0xFFFFFFFFul == t_TempVar_UL) || \
           (0x00000000ul == t_TempVar_UL)  )
      {
        t_Result_UB = (d_CCVhnd_CheckNOK | d_CCVhnd_Ready);
...
} /*-+- END OF FUNCTION 'FUN_CCval_QuickCheck_UB' -+--+-+-+-+-*/ /*l_int !e818 */
