...
|
| Subversion Info:
| $Id: ADLATUS_FUN_Val_LinAdd8Acc16Bit_UB.c 4396 2008-11-04 09:26:32Z maennel $
| $HeadURL: http://smartsvn/svn/adlatusrepository/auslieferungen/S1NN/086350-S1NN-ADLATUS-TMS470R-MucSuc/20081201_S1NN_TMS470R_BlfIso-Source_V1.00/01_SW_Projekt/07_chcklib/02_src/ADLATUS_FUN_Val_LinAdd8Acc16Bit_UB.c $
|
+------------------------------------------------------------------------------+
...
+------------------------------------------------------------------------------+
|                                                                              |
|  Function Name:  FUN_CCVal_LinAdd8Acc16Bit_UB                                |
|                                                                              |
...
UBYTE FUN_CCval_LinAdd8Acc16Bit_UB (VALCONTROL_ST  *Parameters )
{
  ...
  else 
  {
    ...
    while (t_TempAddress_PUB <= Parameters->EndAddress_PBUF)      /*l_int !e946 */
    {
      ...
      /* Increment Address                                                      */
      *t_BufferAddress_PUW += (UWORD)((UWORD)*t_TempAddress_PUB & (UWORD)0x00FFu);
