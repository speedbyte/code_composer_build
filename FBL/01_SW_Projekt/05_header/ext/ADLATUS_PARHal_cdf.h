...
| $HeadURL: http://smartsvn/svn/adlatusrepository/projekte/S1NN/086350-S1NN-ADLATUS-TMS470R-MucSuc/2sw/5int/01_SW_Projekt/05_header/ext/ADLATUS_Hal_cdf.h $
|
+------------------------------------------------------------------------------+
...
/* ========================================================================== */
#ifndef __CDF_PARHAL_
#define __CDF_PARHAL_
/* ========================================================================== */
...
#define d_PARhal_Unit100us_B   FALSE
#define d_PARhal_UnitMS_B      ((BOOL)~FALSE)
