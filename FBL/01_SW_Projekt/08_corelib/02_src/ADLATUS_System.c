...
| $HeadURL: http://smartsvn/svn/adlatusrepository/auslieferungen/S1NN/086350-S1NN-ADLATUS-TMS470R-MucSuc/20081201_S1NN_TMS470R_BlfIso-Source_V1.00/01_SW_Projekt/08_corelib/02_src/ADLATUS_System.c $
|
+------------------------------------------------------------------------------+
...
/*      O N L Y   F O R   T H I S   M O D U L                                 */
/* ========================================================================== */
UWORD const c_VerSMART_Corelib_V110_UW = 0x0110u;
  ...
  while (1)
  {
         ...
         t_Direction_UB ++ )
    {
            ...
            t_ActScanLayer_UB += 0x02 )
      {
        ...
        {
          /*==================================================================*/  /* OPL347 */
          /* -5- we are in the RX-TP                                          */
          /*==================================================================*/
          if (d_CCsys_RxTpLayer == t_ActScanLayer_UB)
          {
            /*----------------------------------------------------------------*/
            /* if we are in the RX-TP also stop the direction loop            */
            /* --> start with the Rx path again                               */
            /*----------------------------------------------------------------*/
            t_Direction_UB = d_CCsys_TxPath + (UBYTE)0x01u;
