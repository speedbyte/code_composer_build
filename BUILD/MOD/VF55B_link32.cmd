...
*-----------------------------------------------------------------------------
* $Date: 2010-03-04 15:39:18 +0100 (Do, 04 Mrz 2010) $
* $Rev: 11330 $
* $Author: goldammer $
* $URL: http://subversion-01/svn/SW_HW_System/Projects/VW_UHV-NAR/SW/SYS_DEV/trunk/MOD/VF55B_link32.cmd $
*-----------------------------------------------------------------------------
*/
...
MEMORY
{
    ...
    VECTORS1  (X)   :   origin=0x00000000   length=0x00000020    /* Arm Vector table : 32 bytes */
   	...
   	ROM       (RX)       : 	origin=0x00008024   length=0x000985D8  /* 609K - 40 bytes	   	 */
   	KOMBI_TEXT_ROM (RX)  :  origin=0x000a05fc   length=0x0001FA00  /* 129k for Kombi text set */
