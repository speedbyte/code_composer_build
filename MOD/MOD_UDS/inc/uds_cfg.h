 ...
 * \brief	This file is delivered as Standard packet and is allowed to be changed.
*/
/*-----------------------------------------------------------------------------
* $Date: 2009-03-30 13:22:47 +0200 (Mo, 30 Mrz 2009) $
* $Rev: 5670 $
* $Author: agrawal $
* $URL: http://subversion-01/svn/SW_HW_System/Projects/VW_UHV-NAR/SW/MOD/MOD_LED/trunk/src/LED_C1.c $
*-----------------------------------------------------------------------------*/
/**************************************************************************
...
extern byte SDS_UDS_ubDiagService23( byte*, word*, byte );
extern byte SDSext_ubDiagService27( byte*, word*, byte );    /* ACHTUNG: Name musste geändert werden !!! siehe ausführlichen Kommentar in sds_cfg.h */
...
{{ 0x01, 0, 0, 0x2D },
 ...
 { 0x23, SDS_UDS_ubDiagService23, 0, 0x20 },
 { 0x27, SDSext_ubDiagService27, 0, 0x2E },
 { 0x28, UDS_ubDiagService28, 1, 0x2C },
 { 0x2F, UDS_ubDiagService2F, 0, 0x2C },
 { 0x31, UDS_ubDiagService31, 0, 0x2F },
 { 0x34, UDS_ubDiagService34, 0, 0x2A },
 { 0x35, UDS_ubDiagService35, 0, 0x28 },
 { 0x36, UDS_ubDiagService36, 0, 0x2A },
 { 0x37, UDS_ubDiagService37, 0, 0x2A },
 { 0x2E, UDS_ubDiagService2E, 0, 0x2C },
 { 0x3D, UDS_ubDiagService3D, 0, 0x20 },
 { 0x3E, UDS_ubDiagService3E, 1, 0x3F },
 { 0x85, UDS_ubDiagService85, 1, 0x2C },
 { 0x86, UDS_ubDiagService86, 1, 0x20 },
 { 0x87, 0, 1, 0x2E }
},
#if( UDS_CLIENTS == 2 )
{{ 0x01, 0, 0, 0x2D },
