...
*/
/*-----------------------------------------------------------------------------
* $Date: 2009-05-29 15:31:50 +0200 (Fr, 29 Mai 2009) $
* $Rev: 6410 $
* $Author: agrawal $
...
#define cub_BS_DEF                           (byte)15  /* block size */
#define cub_ST_DEF                            (byte)5  /* seperation time [ms]: 10 (range = 0..127) */
...
#define cul_REQ_CAN_ID_11BIT_PHYS   (dword)0x0000076B  /* pyhsical request can id for normal and extended addressing */
#define cul_RES_CAN_ID_11BIT        (dword)0x000007D5  /* response can id for normal and extended addressing */
/* -- END normal/extended addressing only -------*/
...
#include "UHV_NAR.h"                                   /* insert here the ecu specific header file generated */
#if( TP_CHANNELS == 1 )
#define  CAN_TX_HANDLE             CanTxISO_Telefon_Resp  /* TP Tx handle within the vector can driver */          
#elif( TP_CHANNELS == 3 )
#ifdef _I2S_TP_C_
