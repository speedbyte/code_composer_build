...
*/
/*-----------------------------------------------------------------------------
* $Date: 2010-04-08 17:02:31 +0200 (Do, 08 Apr 2010) $
* $Rev: 12129 $
* $Author: agrawal $
* $URL: http://subversion-01/svn/SW_HW_System/Projects/VW_UHV-NAR/SW/MOD/MOD_SDS_UDS/trunk/inc/sds_cfg.h $
*-----------------------------------------------------------------------------
*/
/**************************************************************************
...
/*  - C o n s t a n t s -------------------------------------------------- */
/* ----------------------------------------------------------------------- */
#define SDSext_ENABLED                      2            /* weil der Sercive $10, $11 und $19 in uds_appl.c und sds.c realisiert wurde, aber nicht Spec konform */
                                                         /* und da die SW NUR von In2Soft geändert werden DARF => ist dieser Hack notwendig */
                                                         /* allerdings bleibt trotzdem noch das Problem, das der Sercive $27 in uds_appl.c OHNE schalter realisiert wurde */
                                                         /* aber ebenfalls nicht Spec konform => einzige Möglichkeit: den Namen der CALLBACK Funktion UDS_ubDiagService27 in uds_cfg.h */
                                                         /* NICHT verwenden, sondern einen NEUEN Namen SDSext_ubDiagService27 benutzen !!! */

#define SDS_UDS_CLIENT_ID                   0            /* uds client id for SDS */

#define SDS_ECU_PROGRAMABLE                 1            /* 0=not programable, 1=programable */ 

#define SDS_A_DTCStatusAvailabilityMask     0x19         /* 0x19 for ECUs without Warning Lamp */
                                                         /* 0x99 for ECUs with Warning Lamp */
                                                         /* 0xDF for OBD ECUs */

#define SDS_10_ZeroVehicleOrEngineSpeed     SDS_ENABLED  /* check/not-check v and n in servcice $10 */
#define SDS_28_ZeroVehicleOrEngineSpeed     SDS_ENABLED  /* check/not-check v and n in servcice $28 */
#define SDS_85_ZeroVehicleOrEngineSpeed     SDS_DISABLED /* check/not-check v and n in servcice $85 */
                                                         /* should be enabled only for OBD systems */
#define SDS_A_START_DIAGNOSTIC_SESSION      SDSext_ENABLED // Service 10
#define SDS_A_RESET_OR_DISCONNECT           SDSext_ENABLED // Service 11
#define SDS_A_CLEAR_DIAGNOSTIC_INF          SDSext_ENABLED // Service 14
#define SDS_A_READ_DTC_BY_STATUS            SDSext_ENABLED // Service 19
#define SDS_A_READ_DATA_BY_IDENTIFIER       SDSext_ENABLED // Service 22
#define SDS_A_COMMUNICATION_CONTROL         SDS_ENABLED    // Service 28
#define SDS_A_TESTER_PRESENT                SDS_ENABLED    // Service 3E
#define SDS_A_CTRL_DTC_SETTINGS             SDS_ENABLED    // Service 85

#define SDS_11_POWER_DOWN                   SDS_DISABLED  // part of service 11
